...
CKEDITOR.editorConfig = function( config ) {
	...
	// config.uiColor = '#AADC6E';
        config.filebrowserBrowseUrl = 'public/backend/elfinder/for_ckeditor.html?mode=file';
        config.filebrowserImageBrowseUrl = 'public/backend/ckeditor/elfinder/for_ckeditor.html?mode=image';
